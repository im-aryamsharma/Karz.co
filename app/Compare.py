...
columns = ['Company Names', 'Cars Names', 'Engines', 'Fuel Types','Performance(0 - 100 )KM/H', 'Seats', 'Torque', 'Cars Prices']

df['Seats'] = df['Seats'].astype(str)
df['Performance(0 - 100 )KM/H'] = df['Performance(0 - 100 )KM/H'].astype(str)
...
match_fields = ['Company Names', 'Engines', 'Fuel Types','Performance(0 - 100 )KM/H', 'Seats', 'Torque']
